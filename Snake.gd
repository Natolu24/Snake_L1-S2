...
> GROUPE :
- AGUESSE Nathan L1-Z N°21001877
- MOSCATELLI Raphaël L1-Z N°21006543
...
func _ready():
	# Redimensionne la taille de l'écran par défault pour la taille de la grille de jeu
	OS.set_window_size(Vector2(575,575))
